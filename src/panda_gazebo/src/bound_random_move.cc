...
namespace gazebo
{
  class ModelPush : public ModelPlugin
  {
    ...
    public: void OnUpdate()
    {
      ...
      //this->model->SetLinearVel(ignition::math::Vector3d(v_x, 0, 0));

      // Change the angular velocity
      int index = rand() % angular_v_list.size();
      w_z = angular_v_list[index];
    ...
    private: 
      ...
      std::vector<float> angular_v_list{-0.2, 0.0, 0.2};
      ignition::math::Pose3d current_pose;
      ignition::math::Vector3d center;
