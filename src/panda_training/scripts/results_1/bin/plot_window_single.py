...
plt.legend(['Without safety layer', 'With safety layer'], bbox_to_anchor=(1, 1.0),fontsize=fontsize, loc='upper left', borderaxespad=0) # borderaxespad=0

plt.suptitle(titlename, fontsize=fontsize)
plt.savefig("ct_bin_c.pdf", bbox_inches="tight")
plt.show()
...
plt.suptitle(titlename, fontsize=fontsize)
plt.savefig("el_bin_c.pdf", bbox_inches="tight")
plt.show()
...
plt.suptitle(titlename, fontsize=fontsize)
plt.savefig("er_bin_c.pdf", bbox_inches="tight")
plt.show()