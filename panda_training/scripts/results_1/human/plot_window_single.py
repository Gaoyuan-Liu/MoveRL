...
run_unsafe = run_unsafe.iloc[2: min_len, : ].reset_index()
...
plt.savefig("ct_human_c.pdf", bbox_inches="tight")
plt.show()
...
plt.suptitle(titlename, fontsize=fontsize)
plt.savefig("el_human_c.pdf", bbox_inches="tight")
plt.show()
...
ax.get_legend().remove()
plt.suptitle(titlename, fontsize=fontsize)
plt.savefig("er_human_c.pdf", bbox_inches="tight")
plt.show()